...
module Program =
    ...
    let main() =
        ...
        let generateHeight width height =
            ...
            // Beware, "Array.zeroCreate size" will create an array filled with "undefined" elements, not "0" elements.
            // Its probably an issue with the the current FunScript compiler.
        ...
        let init() =
            ...
            // The FunScript.TypeScript library can be used to generate the assembly for these (albeit with a little work).
            ...
            // (for example: { map: texture } in javascript-speak.  For those fields that are enum types, the 
            // possible values are usually found in THREE.Globals
